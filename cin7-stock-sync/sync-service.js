...
function mapProductRow(raw) {
  return {
    ...
    length: parseFloat(raw.Length) || 0,
    width: parseFloat(raw.Width) || 0,
    height: parseFloat(raw.Height) || 0,
    weight: parseFloat(raw.Weight) || 0,
    weight_units: raw.WeightUnits || 'g',
    dimensions_units: raw.DimensionsUnits || 'cm',
    carton_length: parseFloat(raw.CartonLength) || 0,
    carton_width: parseFloat(raw.CartonWidth) || 0,
    carton_height: parseFloat(raw.CartonHeight) || 0,
    carton_quantity: parseFloat(raw.CartonQuantity) || 0,
    carton_inner_quantity: parseFloat(raw.CartonInnerQuantity) || 0,
